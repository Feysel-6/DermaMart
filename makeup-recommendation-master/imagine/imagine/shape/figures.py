...
class Rect:
    ...
    def to_dlib(self):
        ...
        try:
            ...
            raise ImportError("dlib is required for to_dlib() method. Install it with: pip install dlib (requires CMake)")
    ...
    def scale(self, factor, origin=None):
        ...
        new_bounds = (self.top - origin[1],
                      ...
                      self.left - origin[0],
                      self.right - origin[0])
        new_bounds = (factor * np.asarray(new_bounds)).astype(int)
